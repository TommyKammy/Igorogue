...
public static class BattleReplaySerializerV2
{
    public const string SchemaId = BattleReplayFormatV2.SchemaId;
    public const int SchemaVersion = BattleReplayFormatV2.SchemaVersion;
    public const string StateProjection = BattleReplayFormatV2.StateProjection;
    public const int MaxDocumentBytes = 16 * 1024 * 1024;
    public const int MaxAttempts = BattleReplayFormatV2.MaxAttempts;
    ...
    public static void Save(BattleReplayDocumentV2 document, Stream destination)
    {
    ...
    public static BattleReplayDocumentV2 Load(Stream source)
    {
    ...
    private static BattleReplayDocumentV2 FromDto(ReplayDto dto)
    {
        ...
        return BattleReplayDocumentV2.CreateValidated(
            metadata,
    ...
    private static ReplayDto ToDto(BattleReplayDocumentV2 document) => new()
    {
        SchemaId = SchemaId,
    ...
    private static void ValidateSerializationBudget(BattleReplayDocumentV2 document)
    {
