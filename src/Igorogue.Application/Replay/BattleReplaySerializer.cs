...
public static class BattleReplaySerializer
{
    public const string SchemaId = BattleReplayFormat.SchemaId;
    public const int SchemaVersion = BattleReplayFormat.SchemaVersion;
    public const int MaxDocumentBytes = 16 * 1024 * 1024;
    public const int MaxAttempts = BattleReplayFormat.MaxAttempts;
    ...
    public static void Save(BattleReplayDocument document, Stream destination)
    {
    ...
    public static BattleReplayDocument Load(Stream source)
    {
    ...
    private static BattleReplayDocument FromDto(ReplayDto dto)
    {
        ...
        return BattleReplayDocument.CreateValidated(
            metadata,
    ...
    private static ReplayDto ToDto(BattleReplayDocument document) => new()
    {
        SchemaId = SchemaId,
    ...
    private static void ValidateSerializationBudget(BattleReplayDocument document)
    {
    ...
    private sealed record ReplayDto
    {
        ...
        [JsonPropertyName("integrity_scheme"), JsonPropertyOrder(2)]
        public string? IntegrityScheme { get; init; }

        [JsonPropertyName("metadata"), JsonPropertyOrder(3)]
        public MetadataDto? Metadata { get; init; }

        [JsonPropertyName("initial_state_checksum"), JsonPropertyOrder(4)]
        public string? InitialStateChecksum { get; init; }

        [JsonPropertyName("initial_log_checksum"), JsonPropertyOrder(5)]
        public string? InitialLogChecksum { get; init; }

        [JsonPropertyName("attempts"), JsonPropertyOrder(6)]
        public IReadOnlyList<AttemptDto?>? Attempts { get; init; }

        [JsonPropertyName("attempts_checksum"), JsonPropertyOrder(7)]
        public string? AttemptsChecksum { get; init; }

        [JsonPropertyName("final_state_checksum"), JsonPropertyOrder(8)]
        public string? FinalStateChecksum { get; init; }

        [JsonPropertyName("final_log_checksum"), JsonPropertyOrder(9)]
        public string? FinalLogChecksum { get; init; }

        [JsonPropertyName("terminal"), JsonPropertyOrder(10)]
        public TerminalDto? Terminal { get; init; }

        [JsonPropertyName("document_checksum"), JsonPropertyOrder(11)]
