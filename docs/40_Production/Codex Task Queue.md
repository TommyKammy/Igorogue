...
Current: [[TASK-0028 Implement Closed-Window Capture Benefits and TLE Boundary Pressure]] (`review`; closed-window capture benefit and TLE-09／10／15 Domain E3 evidence green).
...
16. [[TASK-0028 Implement Closed-Window Capture Benefits and TLE Boundary Pressure]] — review／current
