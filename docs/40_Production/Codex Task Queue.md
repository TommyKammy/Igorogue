...
Current: [[TASK-0033 Implement Deterministic Battle Deck Hand and Qi Kernel]] (`review`; fixed-HEAD independent review approved after PR #22 merge satisfied dependency TASK-0032).

1. [[TASK-0031 Plan Gate 2 Core Duel Implementation]] — done
2. [[TASK-0032 Implement Typed Core Duel Content Catalog]] — done
3. [[TASK-0033 Implement Deterministic Battle Deck Hand and Qi Kernel]] — review／current
