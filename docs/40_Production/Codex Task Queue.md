...
Current: [[TASK-0033 Implement Deterministic Battle Deck Hand and Qi Kernel]] (`in_progress`; PR #22 merged and dependency TASK-0032 is `done`).

1. [[TASK-0031 Plan Gate 2 Core Duel Implementation]] — done
2. [[TASK-0032 Implement Typed Core Duel Content Catalog]] — done
3. [[TASK-0033 Implement Deterministic Battle Deck Hand and Qi Kernel]] — in progress／current
