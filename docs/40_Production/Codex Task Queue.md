...
Current: [[TASK-0035 Implement Starter Stone Card Effects]] (`in_progress`; PR #24 merged and dependency TASK-0034 is `done`).
...
5. [[TASK-0035 Implement Starter Stone Card Effects]] — in progress／current
