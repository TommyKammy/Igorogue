...
> [!abstract] 現在の目的
> [[TASK-0035 Implement Starter Stone Card Effects]]はPR #25でmerge、post-merge main CI green。[[TASK-0036 Implement Starter Reinforce Effect]]が現在の直列implementation task。TASK-0012 human evidenceは未確認のままDECISION-0007 waiverで進行する。
