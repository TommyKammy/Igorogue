...
Implement TASK-0033's injected-recipe deterministic deck／hand／qi kernel without resolving DECISION-0006.
...
1. Implement／review／merge [[TASK-0033 Implement Deterministic Battle Deck Hand and Qi Kernel]]
