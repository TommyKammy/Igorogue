...
| Product Rules Kernel | determinism through placement/capture implemented; legality/repetition active | TASK-0002 through TASK-0005 tests |
...
[[TASK-0005 Hypothetical Placement and Capture Resolution]] was merged through PR #6 with green CI. [[TASK-0006 Suicide Legality and Terminal Capture]] is the current authorized implementation task.
...
5. TASK-0006 legality and terminal capture — current
