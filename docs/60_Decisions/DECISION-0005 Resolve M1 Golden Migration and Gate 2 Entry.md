...
activeな[[Golden Replay Index]]とAccepted fixture／Feature Spec sourcesはMOM-01〜19、CTR-01〜25をM1 shared Rules Kernel／golden replayへ移植すると定める。しかしactiveな[[Codex Task Queue]]とAcceptedな[[Milestones and Exit Gates]]はMomentum／counterattackをGate 3／M3へ置く。現production code／goldenにMOM／CTR 44 fixturesのruntime implementationがない。
